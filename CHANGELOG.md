...
* **deps:** update semantic-release monorepo 5572018

## 3.12.7 (2026-09-21)

### Bug Fixes

* **deps:** update dependency semantic-release-lerna to v3.6.5 68736e1

## 3.12.6 (2026-09-07)

### Bug Fixes

* **deps:** update dependency semantic-release-lerna to v3.6.4 f39b328

## 3.12.5 (2026-08-31)

### Bug Fixes

* **deps:** update dependency semantic-release-lerna to v3.6.3 4f73e2e

## 3.12.4 (2026-08-25)

### Bug Fixes

* **deps:** update dependency semantic-release-lerna to v3.6.2 b5fe494

## 3.12.3 (2026-08-17)

### Bug Fixes

* **deps:** update dependency semantic-release-lerna to v3.6.1 1a8252d

## 3.12.2 (2026-08-10)

### Bug Fixes

* **deps:** update dependency semantic-release-lerna to v3.6.0 e742a1e
...
* **deps:** update dependency semantic-release-lerna to v3.5.0 0552fb0

## 3.11.3 (2026-08-03)

### Bug Fixes

* **deps:** update dependency semantic-release-lerna to v3.4.1 76b9252

## 3.11.2 (2026-07-27)

### Bug Fixes

* **deps:** update dependency semantic-release-lerna to v3.4.0 61b6e14
...
* **deps:** update semantic-release monorepo 13b45e2

## 3.10.16 (2026-07-21)

### Bug Fixes

* **deps:** update dependency semantic-release to v25.0.8 be5e7f6

## 3.10.15 (2026-07-20)

### Bug Fixes

* **deps:** update dependency semantic-release-lerna to v3.3.3 1c9706c
...
* **deps:** update dependency semantic-release to v25.0.6 968ef00

## 3.10.12 (2026-07-14)

### Bug Fixes

* **deps:** update dependency semantic-release-lerna to v3.3.2 2381979

## 3.10.11 (2026-07-06)

### Bug Fixes

* **deps:** update dependency semantic-release-lerna to v3.3.1 06c46b8

## 3.10.10 (2026-07-04)

### Bug Fixes

* **deps:** update dependency @semantic-release/github to v12.0.9 116f534

## 3.10.9 (2026-07-04)

### Bug Fixes

* **deps:** update dependency semantic-release-lerna to v3.3.0 337f5b2

## 3.10.8 (2026-06-30)

### Bug Fixes

* **deps:** update dependency semantic-release-lerna to v3.2.0 e8883c8

## 3.10.7 (2026-06-22)

### Bug Fixes

* **deps:** update dependency semantic-release-lerna to v3.1.4 2174791

## 3.10.6 (2026-06-16)

### Bug Fixes

* **deps:** update dependency semantic-release-lerna to v3.1.3 5ec9b41
...
* **deps:** update dependency semantic-release-lerna to v3.1.2 8ac0bc6

## 3.10.3 (2026-06-02)

### Bug Fixes

* **deps:** update dependency semantic-release-lerna to v3.1.1 3ad2231

## 3.10.2 (2026-05-25)

### Bug Fixes

* **deps:** update dependency semantic-release-lerna to v3.1.0 ebefeb6

## 3.10.1 (2026-05-18)

### Bug Fixes

* **deps:** update dependency semantic-release-lerna to v3.0.1 d754c8e
...
* **deps:** update dependency semantic-release-lerna to v2.18.4 ad79eae
...
* **deps:** update dependency semantic-release-lerna to v2.18.3 ff0d6fd

## 3.9.3 (2026-04-03)

### Bug Fixes

* **deps:** update dependency semantic-release-lerna to v2.18.2 be467e0
...
* **deps:** update dependency semantic-release-lerna to v2.17.2 61a8457
...
* **deps:** update dependency semantic-release-lerna to v2.17.0 1057b45
* **deps:** update semantic-release monorepo e88e8ae
...
* **deps:** update dependency semantic-release-lerna to v2.16.5 611365b

## 3.7.6 (2026-01-23)

### Bug Fixes

* **deps:** update dependency semantic-release-lerna to v2.16.4 0dc635f

## 3.7.5 (2026-01-16)

### Bug Fixes

* **deps:** update dependency semantic-release-lerna to v2.16.3 ea1fc2a
